...
<svg style="max-width:200px" fill="none" viewBox="-10.12021875 -53.60951036 339.95397529 343.02235093" xmlns="http://www.w3.org/2000/svg">
...
<h1>Blazor WASM Template</h1>
</div>

Our feature-packed Blazor WASM template is ideal for teams with strong C# skills that are looking to build a Line Of Business (LOB) application.
Utilizing Blazor WebAssembly (WASM) integrated with a ServiceStack backend yielding an optimal development model where UIs can bind directly to Typed DTOs and benefit from ServiceStack's [structured error handling](/validation) & rich contextual form validation binding.
