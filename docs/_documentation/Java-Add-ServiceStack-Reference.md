...
dependencies {
    ...
    compile 'net.servicestack:android:1.0.39'
}
```

This also lets you to change which ServiceStack Client library version you want to use, the example above uses **1.0.39**.
