...
JS compatibility was the primary motivation for [transitioning to the Pipe Forward operator](/releases/v5.7#transition-to-js-pipeline-operator-syntax) whose future incorporation into JS will have a lot less friction then continuing to use the unix pipe `|` operator.
