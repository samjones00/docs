...
30. feature-mq           Simple MQ Feature to test sending Messages   to: $HOST  by @ServiceStack  [mq]
31. feature-authrepo     List & Search Users registered in Auth Repo  to: $HOST  by @ServiceStack  [auth]
...
41. grpc                 Configure gRPC (requires .NET Core 3.1)      to: $HOST  by @ServiceStack  [grpc]
...
44. example-validation   Contacts Validation Example                  to: $HOST  by @ServiceStack  [example]
