...
<img class="mt-8" style="" src="/images/overview/servicestack-100m-976w.png">
...
For this first release both **API Explorer** and **Admin UI** consumes the rich metadata powering their UIs using a typed schema that expects API Responses in **camelCase**, i.e. the default JSON serialization used in ASP .NET Core.
...
We'll look at adding support for other text casing options in a future release.
...
### v6 only Breaking Changes
 ...
 - Removed Legacy Projects:
   - [ServiceStack.Wire](https://github.com/ServiceStack/ServiceStack/tree/fx45/src/ServiceStack.Api.Swagger)
