...
If you're not yet ready to move to .NET 6 you can still create new project templates using older release versions of
[ServiceStack's .NET Core project templates](https://github.com/NetCoreTemplates/).
...
to explore its contents. For the `web` template [/v27](https://github.com/NetCoreTemplates/web/tree/v27) was the last
release to target **net5.0** in its `.csproj`.
