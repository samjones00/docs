...
For added flexibility in creating database-agnostic solutions you can reference [OrmLite Variables](/ormlite/typed-sqlexpression-custom-sql#system-variables-and-default-values) which can be configured differently for each
