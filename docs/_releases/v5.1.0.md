...
To simplify configuration you can use the new `plugins/*` wildcard in [web.settings](https://github.com/ServiceStack/dotnet-app/blob/master/src/apps/plugins2/web.settings) at the end of an ordered plugin list to register all remaining Plugins it finds in the apps `/plugins` folder:
...
# [v5.0.2 Release Notes](/releases/v5.0.0)
