...
Which can be chained together to search for all `project` and `sharp` gists we can use for [#Script Pages](https://sharpscript.net/docs/sharp-pages) projects:
...
[#Script Pages](https://sharpscript.net/docs/sharp-pages) to find if it or any dependent layouts, partials or file includes have changed.
