...
Where it benefits from maintaining reusable queries in simple, executable text files that you can organize along with your other 
shell scripts that you can check into a versionable repo, that others can checkout and run from the command-line in Windows, macOS or Linux OS's.
