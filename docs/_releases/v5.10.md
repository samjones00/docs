...
[Sebastian Faltoni](https://github.com/nukedbit) from the ServiceStack community continues to [Blazor WASM Template](https://github.com/nukedbit/blazor-wasm-servicestack) with new support for .NET 5.0.

New ServiceStack + Blazor WASM templates can be created with:
