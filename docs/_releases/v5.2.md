...
[Razor Rockstars content pages](https://github.com/NetCoreTemplates/sharp-webapp/blob/master/rockstars/dead/cobain/index.html), 
...
```hbs
{% raw %}{{ post | return({ format:'json', 'X-Powered-By':'#Script' }) }}{% endraw %}
```
...
The difference with [sharp-webapp](https://github.com/NetCoreTemplates/sharp-webapp) is that the client source code is maintained in the `/client` folder and uses [Parcel JS](https://parceljs.org) to automatically bundle and publish your App to `/app/wwwroot` which is updated with live changes during development.
...
If preferred you can instead develop Server APIs with Sharp APIs, an example is included in [/client/hello/_name.html](https://github.com/NetCoreTemplates/parcel-webapp/blob/master/client/hello/_name.html)
...
[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/templates/htmlClass.png)](https://sharpscript.net/docs/html-scripts#htmlclass)
...
[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/templates/htmlAttrs.png)](https://sharpscript.net/docs/html-scripts#htmlattrs)
