...
| ---------- | -------- | ------------------------- | ----------------------------- | ----------------- | -----------
ServiceStack<BookShelf> | 1 | 0.000 | 0.000 | 69 | 5.0.0.0
ServiceStack<BookShelf> | 1 | 0.000 | 0.000 | 69 | 5.0.0.0
ServiceStack<BookShelf> | 10 | 0.000 | 0.000 | 305 | 5.0.0.0
ServiceStack<BookShelf> | 100 | 0.000 | 0.000 | 2827 | 5.0.0.0
ServiceStack<BookShelf> | 500 | 0.000 | 0.000 | 14827 | 5.0.0.0
ServiceStack<BookShelf> | 1000 | 0.000 | 0.001 | 29829 | 5.0.0.0
ServiceStack<BookShelf> | 10000 | 0.004 | 0.006 | 317831 | 5.0.0.0
ServiceStack<BookShelf> | 50000 | 0.018 | 0.031 | 1677831 | 5.0.0.0
ServiceStack<BookShelf> | 100000 | 0.036 | 0.068 | 3377833 | 5.0.0.0
ServiceStack<BookShelf> | 200000 | 0.073 | 0.146 | 6977833 | 5.0.0.0
ServiceStack<BookShelf> | 500000 | 0.181 | 0.374 | 17777833 | 5.0.0.0
ServiceStack<BookShelf> | 800000 | 0.290 | 0.606 | 28577833 | 5.0.0.0
ServiceStack<BookShelf> | 1000000 | 0.363 | 0.756 | 35777835 | 5.0.0.0
JsonNet<BookShelf> | 1 | 0.000 | 0.000 | 69 | 11.0.2.21924
JsonNet<BookShelf> | 1 | 0.000 | 0.000 | 69 | 11.0.2.21924
JsonNet<BookShelf> | 10 | 0.000 | 0.000 | 305 | 11.0.2.21924
JsonNet<BookShelf> | 100 | 0.000 | 0.000 | 2827 | 11.0.2.21924
JsonNet<BookShelf> | 500 | 0.000 | 0.000 | 14827 | 11.0.2.21924
JsonNet<BookShelf> | 1000 | 0.001 | 0.001 | 29829 | 11.0.2.21924
JsonNet<BookShelf> | 10000 | 0.005 | 0.006 | 317831 | 11.0.2.21924
JsonNet<BookShelf> | 50000 | 0.025 | 0.035 | 1677831 | 11.0.2.21924
JsonNet<BookShelf> | 100000 | 0.051 | 0.073 | 3377833 | 11.0.2.21924
JsonNet<BookShelf> | 200000 | 0.105 | 0.153 | 6977833 | 11.0.2.21924
JsonNet<BookShelf> | 500000 | 0.253 | 0.404 | 17777833 | 11.0.2.21924
JsonNet<BookShelf> | 800000 | 0.400 | 0.726 | 28577833 | 11.0.2.21924
JsonNet<BookShelf> | 1000000 | 0.520 | 0.920 | 35777835 | 11.0.2.21924
...
ServiceStack<BookShelf> | 500 | 0.000 | 0.000 | 14827 | 5.0.0.0
ServiceStack<BookShelf> | 1000 | 0.000 | 0.001 | 29829 | 5.0.0.0
ServiceStack<BookShelf> | 10000 | 0.004 | 0.007 | 317831 | 5.0.0.0
ServiceStack<BookShelf> | 50000 | 0.021 | 0.035 | 1677831 | 5.0.0.0
ServiceStack<BookShelf> | 100000 | 0.043 | 0.072 | 3377833 | 5.0.0.0
ServiceStack<BookShelf> | 200000 | 0.087 | 0.161 | 6977833 | 5.0.0.0
ServiceStack<BookShelf> | 500000 | 0.208 | 0.413 | 17777833 | 5.0.0.0
ServiceStack<BookShelf> | 800000 | 0.340 | 0.669 | 28577833 | 5.0.0.0
ServiceStack<BookShelf> | 1000000 | 0.417 | 0.836 | 35777835 | 5.0.0.0
JsonNet<BookShelf> | 1 | 0.000 | 0.000 | 69 | 11.0.2.21924
JsonNet<BookShelf> | 1 | 0.000 | 0.000 | 69 | 11.0.2.21924
JsonNet<BookShelf> | 10 | 0.000 | 0.000 | 305 | 11.0.2.21924
JsonNet<BookShelf> | 100 | 0.000 | 0.000 | 2827 | 11.0.2.21924
JsonNet<BookShelf> | 500 | 0.000 | 0.000 | 14827 | 11.0.2.21924
JsonNet<BookShelf> | 1000 | 0.001 | 0.001 | 29829 | 11.0.2.21924
JsonNet<BookShelf> | 10000 | 0.005 | 0.007 | 317831 | 11.0.2.21924
JsonNet<BookShelf> | 50000 | 0.025 | 0.038 | 1677831 | 11.0.2.21924
JsonNet<BookShelf> | 100000 | 0.050 | 0.078 | 3377833 | 11.0.2.21924
JsonNet<BookShelf> | 200000 | 0.100 | 0.170 | 6977833 | 11.0.2.21924
JsonNet<BookShelf> | 500000 | 0.250 | 0.439 | 17777833 | 11.0.2.21924
JsonNet<BookShelf> | 800000 | 0.402 | 0.777 | 28577833 | 11.0.2.21924
JsonNet<BookShelf> | 1000000 | 0.503 | 0.992 | 35777835 | 11.0.2.21924
...
as our own non-allocating implementations which are continued to be used until more performant APIs are available.
...
.NET's Compression APIs. 

We haven't been notified of any, but if this change results in any issues, `MemoryStream` pooling can be disabled with:

```csharp
SetConfig(new HostConfig { EnableOptimizations = true })
```

If this does resolves any issues, [please let us know](https://github.com/ServiceStack/Issues/issues/new) so they can be resolved permanently without 
...
To squeeze out a little more performance Reflection.Emit is still enabled in .NET Core and .NET Framework builds.
...
In addition all our Test projects, [.NET Core Templates](https://github.com/NetCoreTemplates), [.NET Core Web Apps](http://templates.servicestack.net/docs/web-apps#example-web-apps), etc have all been upgraded to use .NET Core 2.1.
...
implementation detail whilst ensuring new projects start with same well-known compatible configuration detaults that has been battle tested across a 
...
Avaialble SPA Project Templates now bootstrapped with latest CLI tools and project templates include: 
...
[![](https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vue-spa.png)](https://github.com/NetCoreTemplates/vue-spa)
 ...
 > Live Demo: http://vue-spa.web-templates.io

Create new Vue 2.5 Project:
...
> Live Demo: http://react-spa.web-templates.io

Create new React 16 Project:
...
> Live Demo: http://angular-spa.web-templates.io

Create new Angular 6.1 Project:
...
> Live Demo: http://aurelia-spa.web-templates.io
...
[![](https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vuetify-spa.png)](https://github.com/NetCoreTemplates/vuetify-spa)
 ...
 > Live Demo: http://vuetify-spa.web-templates.io
...
[![](https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vue-nuxt.png)](https://github.com/NetCoreTemplates/vue-nuxt)
 ...
 > Live Demo: http://vue-nuxt.web-templates.io

Create new Nuxt.js v1.4.2 Project:
...
[![](https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vuetify-nuxt.png)](https://github.com/NetCoreTemplates/vuetify-nuxt)
 ...
 > Live Demo: http://vuetify-nuxt.web-templates.io

Create new Nuxt Vuetify Project:
...
[ServiceStack Templates](http://templates.servicestack.net) Website enabling acess to additional flexibility like dynamic Web Pages and server-side rendering
when needed.
...
#### Natural familar syntax for HTML Templating
...
The new support for lambda expressions is now avaialble to all functional filters:
...
shorthand support for single argument lambda expressions which can instead use `=>` without brackets or named arguemnts where it will 
...
As it's results in more wrist-friendly and readable code, [most LINQ Examples](http://templates.servicestack.net/linq/projection-operators#linq15-selectmany---compound-from-2) have been changed to use the shorthand lambda expression syntax above.
...
The `with` Block's contents are also only evaluated if the argument expression is `null`. 
...
For more live previews showcasing advanced usages of `{{#each}}`, checkout the [LINQ Examples](http://templates.servicestack.net/linq/restriction-operators).
...
The `{{#markdown}}` block in [MarkdownTemplatePlugin.cs](https://github.com/ServiceStack/ServiceStack/blob/master/src/ServiceStack/MarkdownTemplatePlugin.cs)
...
| path | page |
------ | ---- |
[/db](http://blog.web-app.io/db) |  |
[/db.html](http://blog.web-app.io/db.html) | [/db.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/db.html) |
[/posts/new](http://blog.web-app.io/posts/new) | |
[/posts/new.html](http://blog.web-app.io/posts/new.html) | [/posts/new.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/posts/new.html)

The default route `/` maps to the `index.html` in the directory if it exists, e.g:

| path | page |
------ | ---- |
[/](http://blog.web-app.io/) | [/index.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/index.html) |
[/index.html](http://blog.web-app.io/index.html) | [/index.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/index.html) |
...
| path | page | arguments |
------ | ---- | --------- |
[/ServiceStack](http://blog.web-app.io/) | [/_user/index.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/_user/index.html) | user=ServiceStack |
[/posts/markdown-example](http://blog.web-app.io/posts/markdown-example) | [/posts/_slug/index.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/posts/_slug/index.html) | slug=markdown-example |
[/posts/markdown-example/edit](http://blog.web-app.io/posts/markdown-example/edit) | [/posts/_slug/edit.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/posts/_slug/edit.html) | slug=markdown-example |
...
This is used in the Blog Web App's [_init.html](https://github.com/NetCoreWebApps/Blog/blob/master/app/_init.html) where it will create a new 
...
in the [/log](http://blog.web-app.io/log) page above.


## Buffered View Pages

After noticing performance regressions from non-buffereing Templates output when hosted behind a reverse proxy, Template Pages served by
...
The preview API above is what provides the new [Blog Wep App's](http://blog.web-app.io/) Live Preview feature where it will render any 
ServiceStack Templates provided in the **content** Query String or HTTP Post Form Data, e.g:

 - {% raw %}[/preview?content={{10|times|select:{pow(index,2)},}}](http://blog.web-app.io/preview?content={{10|times|select:{pow(index,2)},}}){% endraw %}
...
To take the adhoc SQL Query example even further, it also becomes trivial to implement a SQL Viewer to run adhoc queries on your App's configured database.
...
A Template Page to render the UI, short-cut links to quickly see the last 10 rows of each table, a `<textarea/>` to capture the SQL Query which
is sent to an API on every key stroke where the results are displayed instantly:
...
like viewing adhoc SQL Queries in Excel or even just to rapidly prototype APIs so they can be consumed immediately by Client Applications before 
...
Authentication can now be configured using plain text config in your `web.settings` where initially you need register the `AuthFeature` 
...
Any `web.settings` configs that are prefixed with `args.` are made available to Template Pages and any arguments starting with 
...
Build the `server.csproj` project and copy the resulting `server.dll` to `/app/plugins/serer.dll` and start the server with the latest plugin:
...
[Exploring the source code of Live Demos](https://github.com/NetCoreWebApps/Blog/tree/master/app) helps learning how to make use of new features 
...
which can be modified in real-time by any text editor to instantly view changes as they're made. So Apps like http://redis.web-app.io which provide 
a rich Admin UI for searching, browsing and modifying Redis's core data structures, can be easily enhanced by modifying a single 
...
which can be used to create [Live Documents](/posts/live-document-example) or [Render Markdown](/posts/markdown-example) which is itself just 
...
[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/templates/htmlClass.png)](http://templates.servicestack.net/docs/html-filters#htmlclass)
...
[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/templates/htmlAttrs.png)](http://templates.servicestack.net/docs/html-filters#htmlattrs)

  - `containsXss` 

A greedy validation when needing to accept raw HTML but want to validate against embedded JavaScript, used in 
[Blog content validation](https://github.com/NetCoreWebApps/Blog/blob/c656186cbae7c5f3c18ff4d4abfcd201858b0761/app/posts/_slug/edit.html#L26):
...
An alternative way for including the [Hot Reload script](http://templates.servicestack.net/docs/hot-reloading) in **debug** mode:
...
Templates syntax. If you're only viewing your HTML Website through ServiceStack you can use the alternative syntax which wont render the
empty `<i hidden></i>` in release builds:

```hbs
{% raw %}{{#if debug}}<script>{{ '/js/hot-fileloader.js' | includeFile }}</script>{{/if}}{% endraw %}
```
...
### DB Filters
  ...
  - `ormliteVar` - Access RDBMS dialect-provider specific [OrmLite Variables](https://github.com/ServiceStack/ServiceStack.OrmLite#system-variables-and-default-values)
...
// Equivalent to:
{{ assignError: ex }}{{ continueExecutingFiltersOnError }}{% endraw %}
```
...
For added flexibility in creating database-agnostic solutions you can reference [OrmLite Variables](https://github.com/ServiceStack/ServiceStack.OrmLite#system-variables-and-default-values) which can be configured differently for each 
...
When generating the Table definition OrmLite will replace these substitute place holders with the value in each RDBMS DialectProvider's `Variables` Dictionary.
...
`JsonServiceClient.swift` source file you will need to [override the DefaultImports](http://docs.servicestack.net/swift-add-servicestack-reference#defaultimports):
...
[![](https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/dart/dart.png)](/dart-add-servicestack-reference)
...
[.NET HttpWebRequest Service Clients](http://docs.servicestack.net/csharp-client#httpwebrequest-service-clients).
...
Similar to the `IHasSessionId` interface for being able to send [Cookie Session Ids](/sessions#cookie-session-ids), Request DTOs can now also 
...
[change which database connection](http://docs.servicestack.net/multitenancy#changedb-apphost-registration) your Services `Db` connection is configured with:
...
# [v5.1.0 Release Notes](/releases/releases/v5.1.0)
